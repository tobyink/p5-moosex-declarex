...
BEGIN {
	...
	$MooseX::DeclareX::Plugin::protected::VERSION   = '0.002';
}
...
BEGIN {
	...
	$MooseX::DeclareX::Plugin::protected::Role::VERSION   = '0.002';
}
...
BEGIN {
	...
	$MooseX::DeclareX::Plugin::protected::Parser::VERSION   = '0.002';
}
